...
4. A one-paragraph summary covering what was announced, key partners or companies mentioned, financial figures, and overall market significance.
...
async function checkFeed(feed) {
  ...
  for (const item of items) {
    ...
    const { companyMentions, marketSignals, policySignals, summary } = await extractMentions(analysisInput, item.link || feed.url);
